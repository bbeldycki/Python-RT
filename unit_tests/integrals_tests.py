...
class TestEllipticalIntegralsQuartic(unittest.TestCase):
    def test_quartic_all_complex(self):
        data = open_file('test_data_elliptic_integral_quartic_cases.json')
...
#     def __init__(self):
#         super().__init__()
#         self.file = 'test_data_elliptic_integral_cubic_cases.json'

    def test_cubic_all_real(self):
        data = open_file('test_data_elliptic_integral_cubic_cases.json')
